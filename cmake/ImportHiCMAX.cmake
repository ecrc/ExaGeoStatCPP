...
set(flags '-DDPLASMA_PRECISIONS="s;d"' \-DPARSEC_WITH_DEVEL_HEADERS=ON \-DCMAKE_Fortran_FLAGS="-Wno-main"
    \-DPARSEC_GPU_WITH_HIP=OFF \-DPARSEC_GPU_WITH_CUDA=${USE_CUDA} \-DPARSEC_HAVE_CUDA=${USE_CUDA} \-DPARSEC_DIST_SHORT_LIMIT=0
    \-DPARSEC_DIST_COLLECTIVES=ON \-DPARSEC_HAVE_DEV_CUDA_SUPPORT=${USE_CUDA} \-DDPLASMA_HAVE_CUDA=${USE_CUDA} \-DBLA_VENDOR=${BLA_VENDOR})
