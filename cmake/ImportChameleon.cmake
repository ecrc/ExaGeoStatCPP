...
if (NOT TARGET CHAMELEON_FOUND)
    ...
    # If Chameleon is not found, install it
        ...
        set(FLAGS \-DCMAKE_CXX_COMPILER=CC \-DCMAKE_C_COMPILER=cc \-DCHAMELEON_USE_CUDA=${USE_CUDA} \-DBLA_VENDOR=Intel10_64lp \-DCHAMELEON_USE_MPI=${USE_MPI} \-DCHAMELEON_SCHED_STARPU=ON \-DCHAMELEON_ENABLE_TESTING=OFF)
        set(ISCMAKE ON)
        set(ISGIT ON)
        set(AUTO_GEN OFF)
        # Install Chameleon
