...
if (NOT TARGET CHAMELEON_FOUND)
    ...
    if (CHAMELEON_FOUND)
        ...
        set(FLAGS -DCMAKE_INSTALL_PREFIX=${PROJECT_SOURCE_DIR}/installdir/_deps " " -DCHAMELEON_USE_CUDA=${USE_CUDA} " " -DCHAMELEON_USE_MPI=${USE_MPI} " " -DCHAMELEON_SCHED_STARPU=ON)
        set(ISCMAKE ON)
        set(ISGIT ON)
