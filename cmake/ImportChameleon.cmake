...
if (NOT TARGET CHAMELEON_FOUND)
    ...
    if (CHAMELEON_FOUND)
        ...
        set(FLAGS -DCMAKE_INSTALL_PREFIX=${PROJECT_SOURCE_DIR}/installdir/_deps/CHAMELEON/)
        list(APPEND FLAGS "-DCHAMELEON_USE_CUDA=${USE_CUDA}")
        list(APPEND FLAGS "-DCHAMELEON_USE_MPI=${USE_MPI}")
        list(APPEND FLAGS "-DCHAMELEON_SCHED_STARPU=ON")
        set(ISCMAKE ON)
        set(ISGIT ON)
