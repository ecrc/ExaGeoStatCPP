...
if (NOT TARGET STARPU)
    ...
    find_package(STARPU QUIET COMPONENTS ${STARPU_COMPONENT_LIST})
    ...
    if (STARPU_FOUND)
        ...
        find_package(STARPU REQUIRED COMPONENTS ${STARPU_COMPONENT_LIST})
    endif ()
else ()
...
message("YABAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA")
message(${STARPU_INCLUDE_DIRS})
