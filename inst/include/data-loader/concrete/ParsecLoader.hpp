...
namespace exageostat::dataLoader::parsec {
    ...
    public:
         ...
         *
         */
        static int ReadCSVFileHelper(const char* apFilename, double *apFileContent, int aM, int aN);
         ...
         *
         */
        static void CompressMatrixHelper(configurations::Configurations &aConfigurations, std::unique_ptr<ExaGeoStatData<T>> &aData);
