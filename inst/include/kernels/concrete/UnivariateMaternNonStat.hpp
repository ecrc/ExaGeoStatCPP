...
namespace exageostat::kernels {
    ...
    public:
         ...
         */
        static double
        CalculateMahalanobisDistanceSquared(double aX1, double aY1, double aX2, double aY2, double aA11, double aA12,
                                            double aA21, double aA22);

        /**
         * Utility function that evaluates the matern. Similar to (https://www.rdocumentation.org/packages/PrevMap/versions/1.5.3/topics/matern.kernel) in R
