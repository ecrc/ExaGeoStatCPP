...
namespace exageostat {
    namespace kernels {
         ...
         * @brief A class representing a Univariate Matern Dbeta kernel.
         *
         * This class represents a Univariate Matern Dbeta kernel, which is a subclass of the Kernel class. It provides
         * a method for generating a covariance matrix using a set of input locations and kernel parameters.
         */
        class UnivariateMaternDbeta : public Kernel {
        ...
        public:
             ...
             *
             * Initializes a new UnivariateMaternDbeta object with default values.
             */
             ...
             *
             * This method creates a new UnivariateMaternDbeta object and returns a pointer to it.
             */
