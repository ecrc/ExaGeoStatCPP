...
void TEST_ALL_R_METHODS() {
    SECTION("R METHODS") {
        ...
        auto configurations = R_InitializeArguments(16, "univariate_matern_stationary", {8, 0}, {1, 1}, 1, "exact",
                                                    "double", {1, 0}, 0, 1, {1, 0.1, 0.5}, {{0.1, 0.1, 0.1}, {5,   5,   5}},
                                                    {-1, -1, -1}, "standard", "2D", 10, 4, {5, 1, 1, 1, 1},
                                                    {"", "", "", ""}, false);
