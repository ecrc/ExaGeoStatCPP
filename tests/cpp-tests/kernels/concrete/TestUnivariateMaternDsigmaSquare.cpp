...
/**
 * @file TestUnivariateMaternDsigmaSquare.cpp
 * @brief
 * @version 1.0.0
...
void TEST_KERNEL_GENERATION_UnivariateMaternDsigmaSquare() {
    ...
    synthetic_data_configurations.SetKernel("UnivariateMaternDsigmaSquare");
    ...
    vector<double> initial_theta{1, 1, 0.01};
    ...
    double expected_output_data[] = {1, 0.0306587, 0.0133114, 0.0152227, 0.0306587, 1, 0.0174979, 0.0231104, 0.0133114,
                                     0.0174979, 1, 0.0275274, 0.0152227, 0.0231104, 0.0275274, 1, 0, 0, 0, 0};
    int m = 4;
    int n = 5;
    for (int i = 0; i < m * n; i++) {
...
TEST_CASE("UnivariateMaternDsigmaSquare kernel test") {
