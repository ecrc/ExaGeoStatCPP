...
// Initialise ExaGeoStat Hardware.
        ...
        double expected_output_data[] = {0, 0.039671, 0.000803892, 0.00171723,
                                         0.039671, 0, 0.00360685, 0.0135064,
                                         0.000803892, 0.00360685, 0, 0.0272409,
                                         0.00171723, 0.0135064, 0.0272409, 0};
        int m = 4;
        int n = 4;
        for (int i = 0; i < m * n; i++) {
