...
void TEST_KERNEL_GENERATION_UnivariateMaternDnu() {
    ...
    synthetic_data_configurations.SetKernel("UnivariateMaternDnu");
    ...
    double expected_output_data[] = {0, 0.0163331, 0.000139344, 0.000332556, 0.0163331, 0, 0.000791289, 0.00393537,
                                     0.000139344, 0.000791289, 0, 0.00975586, 0.000332556, 0.00393537, 0.00975586, 0, 0, 0, 0, 0};
    int m = 4;
    int n = 5;
    for (int i = 0; i < m * n; i++) {
