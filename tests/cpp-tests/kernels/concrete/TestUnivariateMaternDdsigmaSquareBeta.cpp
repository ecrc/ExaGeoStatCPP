...
void TEST_KERNEL_GENERATION_UnivariateMaternDdsigmaSquareBeta() {
    ...
    SECTION("UnivariateMaternDdsigmaSquareBeta") {
        ...
        synthetic_data_configurations.SetKernel("UnivariateMaternDdsigmaSquareBeta");
        ...
        double expected_output_data[] = {0, 0.39671, 0.00803892, 0.0171723, 0.39671, 0, 0.0360685, 0.135064, 0.00803892,
                                         0.0360685, 0, 0.272409, 0.0171723, 0.135064, 0.272409, 0, 0, 0, 0, 0};
        int m = 4;
        int n = 5;
        for (int i = 0; i < m * n; i++) {
