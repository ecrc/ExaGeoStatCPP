...
cout << "Running Configurations example with arguments: " + arguments_string << endl <<
flush;
...
cout << "Running synthetic locations example with arguments: " + arguments_string << endl <<
flush;
...
cout << "Running Data Generation Module example with arguments: " + arguments_string << endl <<
flush;
...
#endif
cout << "Running Data Modeling example with arguments: " + arguments_string << endl <<
flush;
...
cout << "Running Data Prediction example with arguments: " + arguments_string << endl <<
flush;
...
cout << "Running Data data generation and modeling example with arguments: " + arguments_string << endl <<
flush;
