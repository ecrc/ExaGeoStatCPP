...
template<typename T>
void HicmaImplementation<T>::ExaGeoStatPotrfTile(const UpperLower &aUpperLower, void *apA, int aBand,
...
template<typename T>
void HicmaImplementation<T>::ExaGeoStatTrsmTile(const Side &aSide, const UpperLower &aUpperLower,
                                                const Trans &aTrans, const Diag &aDiag, const T &aAlpha,
